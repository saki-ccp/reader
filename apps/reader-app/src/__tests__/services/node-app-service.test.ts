...
describe('NodeAppService', () => {
  ...
  it('should switch to new root via setCustomRootDir', async () => {
    ...
    try {
      ...
      expect(service.localBooksDir).toBe(path.join(newRoot, 'Reader', 'Books'));
