...
!macro NSIS_HOOK_POSTINSTALL
    DetailPrint "Registering Reader Thumbnail Provider..."
    ...
    WriteRegStr HKCR "CLSID\${CLSID_READEST_THUMBNAIL}" "" "Reader Thumbnail Provider"
    WriteRegStr HKCR "CLSID\${CLSID_READEST_THUMBNAIL}\InprocServer32" "" "$INSTDIR\reader_thumbnail.dll"
...
!macro NSIS_HOOK_PREUNINSTALL
    DetailPrint "Unregistering Reader Thumbnail Provider..."
    ...
    ; Delete the DLL file
    Delete "$INSTDIR\reader_thumbnail.dll"
